...
2. Измените ту же самую строчку в файле test.sh.
3. Сделайте коммит и пуш.
4. Сделайте мердж ветки conflict в основную ветку и решите конфликт так, чтобы в результате в файле оказался код из ветки conflict.
